    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="numberOfSpaces" className="block text-sm font-medium text-gray-700 mb-1">
        ...
        {quoteResult && (
          <div className="mt-6 p-4 border border-green-200 rounded-md bg-green-50">
            ...
            <p className="text-gray-700">
              Tarifa calculada: <span className="font-bold">{formatCurrency(quoteResult.rate)}</span>
            </p>
          </div>
        )}
      </div>
